...
export default function LogsPage() {
  ...
  // Фильтрация логов по номеру заказа или email пользователя
  const filteredLogs = generalLogsData?.filter(
    (order: any) =>
                        ...
                        {filteredLogs.map((order: any) => (
                          <TableRow key={order.id}>
                            ...
                            <TableCell className="font-medium">
                              $
                              {Number.parseFloat(order.totalPrice || 0).toFixed(
                                2
                              )}
                            </TableCell>
                            <TableCell className="font-mono text-xs">
